...
\begin{mdframed}[style=destaque]
\textbf{\color{ballblue}R7 e R8 --- Conserva\c{c}\~ao de Massa no Transbordo (Docas).}
...
& \sum_{l \in L_p} g_{i,p,l,t} = \sum_{\substack{o \in P \\ o \neq p}} f_{i,o,p,t} && \forall\, i \in I,\; p \in P,\; t \in T \tag{R7} \\[10pt]
& \sum_{l \in L_p} s_{i,p,l,t} = \sum_{\substack{d \in P \\ d \neq p}} f_{i,p,d,t} && \forall\, i \in I,\; p \in P,\; t \in T \tag{R8} \\[10pt]
& x_{i,p,l,t},\; e_{i,p,l,t},\; a_{i,p,l,t},\; f_{i,o,d,t},\; g_{i,p,l,t},\; s_{i,p,l,t} \geq 0 && \forall\, i, p, l, o, d, t \tag{R6}
\end{align}
\end{mdframed}
